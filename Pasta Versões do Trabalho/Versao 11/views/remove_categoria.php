...
// Processa a remoção do categoria
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($id_categoria) {
        ...
        if ($stmt->execute()) {
            ...
            $message = "Erro ao remover categoria: " . $stmt->error;
        }
...
<body>
    ...
    <form method="POST" action="remove_categoria.php">
        <label for="id_categoria">ID do categoria:</label>
